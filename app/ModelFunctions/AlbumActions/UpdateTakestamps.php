...
class UpdateTakestamps
{
     ...
     */
    public static function update_min_max_takestamp(Album $album): void
    {
     ...
     *
     * @param array<int> $takestamps : an array with the takestamps of changed
     ...
     */
    public static function update_takestamps(Album $album, array $takestamps, bool $adding): bool
    {
     ...
     * during migration.
     */
    public static function reset_takestamp(): void
    {
        $albums = Album::get();
