...
class PhotoController extends Controller
{
     ...
     */
    public function setStar(Request $request): string
    {
        $request->validate([
            'photoIDs' => 'required|string',
        ]);
     ...
     */
    public function setDescription(Request $request): string
    {
        $request->validate([
     ...
     */
    public function setPublic(Request $request): string
    {
        $request->validate([
            'photoID' => 'required|string',
        ]);
     ...
     */
    public function setTags(Request $request): string
    {
        $request->validate([
            'photoIDs' => 'required|string',
     ...
     */
    public function setAlbum(Request $request): string
    {
        $request->validate([
            'photoIDs' => 'required|string',
     ...
     */
    public function duplicate(Request $request): string
    {
        $request->validate([
            'photoIDs' => 'required|string',
            'albumID' => 'string',
        ...
        foreach ($photos as $photo) {
            ...
            $duplicate->album_id = $request['albumID'] ?? $photo->album_id;
