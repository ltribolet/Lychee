...
INSERT INTO `configs`
VALUES (1, 'version', '040006', 'Admin', 'int', 0, ''),
       (4, 'check_for_updates', '0', 'Admin', '0|1', 0, ''),
       (5, 'sorting_Photos_col', 'takestamp', 'Gallery', 'id|takestamp|title|description|public|star|type', 2, ''),
       (6, 'sorting_Photos_order', 'ASC', 'Gallery', 'ASC|DESC', 2, ''),
       (7, 'sorting_Albums_col', 'max_takestamp', 'Gallery',
        'id|title|description|public|max_takestamp|min_takestamp|created_at', 0, ''),
       (8, 'sorting_Albums_order', 'ASC', 'Gallery', 'ASC|DESC', 0, ''),
       (9, 'imagick', '1', 'Image Processing', '0|1', 2, ''),
       (10, 'dropbox_key', '', 'Admin', 'string', 3, ''),
       (11, 'skip_duplicates', '0', 'Image Processing', '0|1', 2, ''),
       (12, 'small_max_width', '0', 'Image Processing', 'int', 2, ''),
       (13, 'small_max_height', '360', 'Image Processing', 'int', 2, ''),
       (14, 'medium_max_width', '1920', 'Image Processing', 'int', 2, ''),
       (15, 'medium_max_height', '1080', 'Image Processing', 'int', 2, ''),
       (16, 'lang', 'en', 'Gallery', '', 0, ''),
       (17, 'layout', '1', 'Gallery', '0|1|2', 0, ''),
       (18, 'image_overlay', '1', 'Gallery', '0|1', 0, ''),
       (19, 'image_overlay_type', 'desc', 'Gallery', 'exif|desc|takedate', 0, ''),
       (20, 'default_license', 'none', 'Gallery', 'license', 2, ''),
       (21, 'compression_quality', '90', 'Image Processing', 'int', 2, ''),
       (22, 'full_photo', '1', 'Gallery', '0|1', 0, ''),
       (23, 'delete_imported', '0', 'Image Processing', '0|1', 2, ''),
       (24, 'Mod_Frame', '1', 'Mod Frame', '0|1', 0, ''),
       (25, 'Mod_Frame_refresh', '30', 'Mod Frame', 'int', 0, ''),
       (26, 'thumb_2x', '1', 'Image Processing', '0|1', 2, ''),
       (27, 'small_2x', '1', 'Image Processing', '0|1', 2, ''),
       (28, 'medium_2x', '1', 'Image Processing', '0|1', 2, ''),
       (29, 'landing_page_enable', '0', 'Mod Welcome', '0|1', 0, ''),
       (30, 'landing_owner', 'John Smith', 'Mod Welcome', 'string', 2, ''),
       (31, 'landing_title', 'John Smith', 'Mod Welcome', 'string', 2, ''),
       (32, 'landing_subtitle', 'Cats, Dogs & Humans Photography', 'Mod Welcome', 'string', 2, ''),
       (33, 'landing_facebook', 'https://www.facebook.com/JohnSmith', 'Mod Welcome', 'string', 2, ''),
       (34, 'landing_flickr', 'https://www.flickr.com/JohnSmith', 'Mod Welcome', 'string', 2, ''),
       (35, 'landing_twitter', 'https://www.twitter.com/JohnSmith', 'Mod Welcome', 'string', 2, ''),
       (36, 'landing_instagram', 'https://instagram.com/JohnSmith', 'Mod Welcome', 'string', 2, ''),
       (37, 'landing_youtube', 'https://www.youtube.com/JohnSmith', 'Mod Welcome', 'string', 2, ''),
       (38, 'landing_background', 'dist/cat.jpg', 'Mod Welcome', 'string', 2, ''),
       (39, 'site_title', 'Lychee v4', 'config', 'string', 0, ''),
       (40, 'site_copyright_enable', '1', 'config', '0|1', 2, ''),
       (41, 'site_copyright_begin', '2019', 'config', 'int', 2, ''),
       (42, 'site_copyright_end', '2019', 'config', 'int', 2, ''),
       (43, 'api_key', '', 'Admin', 'string', 3, ''),
       (44, 'allow_online_git_pull', '1', 'Admin', '0|1', 3, ''),
       (45, 'force_migration_in_production', '0', 'Admin', '0|1', 3, ''),
       (46, 'additional_footer_text', '', 'config', 'string', 2, ''),
       (47, 'display_social_in_gallery', '0', 'config', '0|1', 2, ''),
       (48, 'public_search', '0', 'config', '0|1', 0, ''),
       (49, 'gen_demo_js', '0', 'Admin', '0|1', 3, ''),
       (50, 'hide_version_number', '0', 'config', '0|1', 3, ''),
       (51, 'SL_enable', '0', 'Symbolic Link', '0|1', 2, ''),
       (52, 'SL_for_admin', '0', 'Symbolic Link', '0|1', 2, ''),
       (53, 'SL_life_time_days', '7', 'Symbolic Link', 'int', 3, ''),
       (54, 'public_recent', '0', 'Smart Albums', '0|1', 0, ''),
       (55, 'recent_age', '1', 'Smart Albums', 'int', 2, ''),
       (56, 'public_starred', '0', 'Smart Albums', '0|1', 0, ''),
       (57, 'downloadable', '0', 'config', '0|1', 0, ''),
       (58, 'photos_wraparound', '1', 'Gallery', '0|1', 0, ''),
       (59, 'raw_formats', '.tex', 'config', '', 3, ''),
       (60, 'map_display', '0', 'Mod Map', '0|1', 0, ''),
       (61, 'zip64', '1', 'config', '0|1', 0, ''),
       (62, 'map_display_public', '0', 'Mod Map', '0|1', 0, ''),
       (63, 'map_provider', 'Wikimedia', 'Mod Map',
        'Wikimedia|OpenStreetMap.org|OpenStreetMap.de|OpenStreetMap.fr|RRZE', 0, ''),
       (64, 'force_32bit_ids', '0', 'config', '0|1', 0, ''),
       (65, 'map_include_subalbums', '0', 'Mod Map', '0|1', 0, ''),
       (66, 'update_check_every_days', '3', 'config', 'int', 2, ''),
       (67, 'has_exiftool', '1', 'Image Processing', '0|1|2', 2, ''),
       (68, 'share_button_visible', '0', 'config', '0|1', 0, ''),
       (69, 'import_via_symlink', '0', 'Image Processing', '0|1', 2, ''),
       (70, 'has_ffmpeg', '1', 'Image Processing', '0|1|2', 2, ''),
       (71, 'apply_composer_update', '0', 'Admin', '0|1', 3, ''),
       (72, 'location_decoding', '0', 'Mod Map', '0|1', 0, ''),
       (73, 'location_decoding_timeout', '30', 'Mod Map', 'int', 0, ''),
       (74, 'location_show', '1', 'Mod Map', '0|1', 0, ''),
       (75, 'location_show_public', '0', 'Mod Map', '0|1', 0, ''),
       (76, 'rss_enable', '0', 'Mod RSS', '0|1', 0, ''),
       (77, 'rss_recent_days', '7', 'Mod RSS', 'int', 0, ''),
       (78, 'rss_max_items', '100', 'Mod RSS', 'int', 0, ''),
       (79, 'prefer_available_xmp_metadata', '0', 'Image Processing', '0|1', 2, ''),
       (80, 'editor_enabled', '1', 'Image Processing', '0|1', 2, ''),
       (81, 'lossless_optimization', '1', 'Image Processing', '0|1', 2, '');
